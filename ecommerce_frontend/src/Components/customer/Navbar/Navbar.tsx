        ...
        <div className="container-fluid bg-dark mb-30">
            <div className="row px-xl-5">
                <div className="col-lg-3 d-none d-lg-block">
                    ...
                    <nav style={{ zIndex: "1000", width: "calc(100% - 30px)"}} className="collapse position-absolute navbar navbar-vertical navbar-light align-items-start p-0 bg-light" id="navbar-vertical" >
                        <div className="navbar-nav w-100 shadow">
                    ...
                    <nav className="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                        ...
                        <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                            <div className="navbar-nav mr-auto py-0">
                                <a onClick={() => navigate("/")} style={{cursor: "pointer"}} className="nav-item nav-link ">Home</a>
                                <a onClick={() => navigate("/shop")} style={{cursor: "pointer"}} className="nav-item nav-link">Shop</a>
